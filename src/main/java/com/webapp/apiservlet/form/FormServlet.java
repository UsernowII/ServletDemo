package com.webapp.apiservlet.form;
...
public class FormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (email == null || !email.contains("@")) {
            errores.put("email","El email es requerido y debe tener un formato correo");
        }

        if (pais == null || pais.equals("") || pais.equals(" ")) {//isblank compara si es null o si es un espacio blanco
